...
function patchRender() {
    ...
    if(aleiSettings.customRenderer) {
        ...
        "use strict";let decorRequestsOnProgress=[],backgroundRequestsOnProgress=[],boxModelImages={},aleiRunning=!1,haveForcedRecalculation=!1,displayFPS=0,fpsAccumulator=0,totalRenderedObjects=0,lastTime=0,draw_rect,draw_rect_edges,draw_gridlines,draw_image,ctx,canvasHeight,canvasWidth,gridOpacity,mClickX,mClickY,mCurrentX,mCurrentY,w2s_x,w2s_y,s2w_x,s2w_y,w2s_h,w2s_w,s2w_h,s2w_w,previewBackground="1";function _readStorage(e,t,r){let l=`ALEI_Renderer_${e}`;return void 0===localStorage[l]?t:r(localStorage[l])}let toggles={cartoonishEdges:_readStorage("CartoonishEdges",!1,e=>"true"===e),originalSelectOverlay:_readStorage("OriginalSelectOverlay",!1,e=>"true"===e),boxRendering:_readStorage("PreviewWalls",!1,e=>"true"===e)},themes={0:{backgroundColor:"#5880AB",gridColor:"#FFFFFF",selectOutlineColor:"#A5A500",selectEdgeOpacityFactor:1,selectTextColor:"#FF0",selectionColor:"#FFF",selectionCtrlColor:"#AFA",selectionAltColor:"#FAA",selectionOpacity:.1,selectionEdgeOpacity:.8,highLightedObjEdgeColor:window.selgrd3,highLightedObjEdgeOpacity:1},1:{backgroundColor:"#222222",gridColor:"#888888",selectOutlineColor:"#FFFF00",selectEdgeOpacityFactor:1,selectTextColor:"#FF0",selectionColor:"#FFF",selectionCtrlColor:"#AFA",selectionAltColor:"#FAA",selectionOpacity:.1,selectionEdgeOpacity:.8,highLightedObjEdgeColor:window.selgrd3,highLightedObjEdgeOpacity:1},2:{backgroundColor:"#222222",gridColor:"#FFFFFF",selectOutlineColor:"#FFFF00",selectEdgeOpacityFactor:1,selectTextColor:"#FF0",selectionColor:"#FFF",selectionCtrlColor:"#AFA",selectionAltColor:"#FAA",selectionOpacity:.1,selectionEdgeOpacity:.8,highLightedObjEdgeColor:window.selgrd3,highLightedObjEdgeOpacity:1},3:{backgroundColor:"#222222",gridColor:"#FFFFFF",selectOutlineColor:"#FFFF00",selectEdgeOpacityFactor:1,selectTextColor:"#FF0",selectionColor:"#FFF",selectionCtrlColor:"#AFA",selectionAltColor:"#FAA",selectionOpacity:.1,selectionEdgeOpacity:.8,highLightedObjEdgeColor:window.selgrd3,highLightedObjEdgeOpacity:1},4:{backgroundColor:"#222222",gridColor:"#FFFFFF",selectOutlineColor:"#FFFF00",selectEdgeOpacityFactor:1,selectTextColor:"#FF0",selectionColor:"#FFF",selectionCtrlColor:"#AFA",selectionAltColor:"#FAA",selectionOpacity:.1,selectionEdgeOpacity:.8,highLightedObjEdgeColor:window.selgrd3,highLightedObjEdgeOpacity:1}},currentTheme;function RenderGrid(){gridOpacity<=0||(ctx.fillStyle=currentTheme.gridColor,draw_gridlines(10,.08*gridOpacity),draw_gridlines(100,.32*gridOpacity),draw_gridlines(300,.64*gridOpacity),ctx.globalAlpha=.7*gridOpacity,draw_rect(0,w2s_y(0),canvasWidth,1),draw_rect(w2s_x(0),0,1,canvasHeight))}let objectColors={box:{col:"#FFF",edgeCol:"#FFF"},door:{col:"#000",edgeCol:"#000",invisibleOpacityFactor:.05},water:{col:"#3592B9",edgeCol:"#91EAFF",opacityFactor:.24,acidCol:"#BBFB59",acidEdgeCol:"#91EAFF",acidOpacityFactor:.81},pushf:{col:"#2BFF40",edgeCol:"#3CFF4F"},region:{col:"#FFD52B",edgeCol:"#FFB03C",edgeOpacityFactor:.5,buttonOpacityFactor:.5},bg:{col:"#000",edgeCol:"#910000",edgeOpacityFactor:.3,coloredOpacityFactor:.22}},regionImages={1:window.img_region,9:window.img_region_red,10:window.img_region_blue};function _DrawRectangle(e,t,r,l,i,s,o){ctx.globalAlpha=t,o?(toggles.cartoonishEdges?ctx.strokeColor=e:ctx.strokeStyle=e,draw_rect_edges(r,l,i,s)):(ctx.fillStyle=e,draw_rect(r,l,i,s))}function ObjIsHighlighted(e,t){if(!window.m_drag_selection||window.lmd||!window.MatchLayer(e))return;let r=w2s_x(Math.min(mClickX,mCurrentX)),l=w2s_y(Math.min(mClickY,mCurrentY)),i=w2s_w(Math.abs(mCurrentX-mClickX)),s=w2s_h(Math.abs(mCurrentY-mClickY)),o=t.x,c=t.y,a=t.w,n=t.h;return!(o+a<r)&&!(r+i<o)&&!(c+n<l)&&!(l+s<c)}function RenderSingleResizableObject(e,t){let r=e._class,l=objectColors[r];if(void 0===l)return;let i=window.MatchLayer(e)?1:.3,s=e.pm,o=w2s_x(s.x),c=w2s_y(s.y),a=w2s_w(s.w),n=w2s_h(s.h),d=l.col,g=l.edgeCol,w=l.opacityFactor?l.opacityFactor:.2,h=l.edgeOpacityFactor?l.edgeOpacityFactor:1;if("bg"==r&&void 0==window.CACHED_BGS[s.m]&&-1==backgroundRequestsOnProgress.indexOf(s.m)&&(window.ServerRequest(`a=get_images&for_class=bg_model&update_const=${s.m}`,"request_consts"),backgroundRequestsOnProgress.push(s.m)),"door"==r&&(0===s.vis||!1===s.vis||"false"===s.vis))w=l.invisibleOpacityFactor;else if("water"==r&&e.pm.damage>0)d=l.acidCol,g=l.acidEdgeCol,w=l.acidOpacityFactor;else if("region"==r&&-1!==[1,9,10].indexOf(parseInt(s.use_on))){ctx.globalAlpha=i*l.buttonOpacityFactor;draw_image(regionImages[s.use_on],w2s_x(s.x+Math.round((s.w-41)/2)),w2s_y(s.y+Math.round((s.h-51)/2)),w2s_w(41),w2s_h(31))}else"bg"==r&&7==s.c.length&&(d=s.c,w=l.coloredOpacityFactor);if(window.SHOW_TEXTURES){if("box"!=r||toggles.boxRendering){if("box"==r&&toggles.boxRendering){let u=boxModelImages[s.m];void 0==u&&(u=new Image,boxModelImages[s.m]=u,u.src=`pic.php?c=3&m=${s.m}`,u.width=16,u.height=16),void 0==u.pattern&&(u.pattern=ctx.createPattern(u,"repeat-x")),ctx.globalAlpha=1,ctx.save(),ctx.beginPath(),ctx.rect(o,c,a,n),ctx.closePath(),ctx.clip(),ctx.translate(w2s_x(0),w2s_y(0)),ctx.scale(w2s_x(1)-w2s_x(0),w2s_y(1)-w2s_y(0)),ctx.beginPath(),ctx.fillStyle=u.pattern,ctx.rect(s2w_x(0),s2w_y(0),s2w_w(canvasWidth),s2w_h(canvasHeight)),ctx.fill(),ctx.restore()}else if("bg"==r&&void 0!==window.CACHED_BGS[s.m]&&window.CACHED_BGS[s.m].loaded){-1!==backgroundRequestsOnProgress.indexOf(s.m)&&backgroundRequestsOnProgress.splice(backgroundRequestsOnProgress.indexOf(s.m),1),ctx.globalAlpha=1;let x=window.CACHED_BGS[s.m];if(void 0==x.pattern&&(x.pattern=ctx.createPattern(x,"repeat")),ctx.save(),ctx.beginPath(),ctx.rect(o,c,a,n),ctx.closePath(),ctx.clip(),ctx.translate(w2s_x(0),w2s_y(0)),ctx.scale(w2s_x(1)-w2s_x(0),w2s_y(1)-w2s_y(0)),ctx.translate(s.u,s.v),ctx.beginPath(),ctx.fillStyle=x.pattern,ctx.rect(s2w_x(0),s2w_y(0),s2w_w(canvasWidth),s2w_h(canvasHeight)),ctx.fill(),ctx.restore(),7==s.c.length){let m=ctx.globalCompositeOperation;ctx.globalCompositeOperation="multiply",_DrawRectangle(s.c,1,o,c,a,n,!1),ctx.globalCompositeOperation=m}}}else d="#000",w=1,g="#333"}ObjIsHighlighted(e,t)&&(g=currentTheme.highLightedObjEdgeColor,h=currentTheme.highLightedObjEdgeOpacity/i),e.selected&&!toggles.originalSelectOverlay&&(g=currentTheme.selectOutlineColor,h=currentTheme.selectEdgeOpacityFactor),window.SHOW_TEXTURES&&("bg"==r||"box"==r&&toggles.boxRendering)||_DrawRectangle(d,i*w,o,c,a,n,!1),window.SHOW_TEXTURES||_DrawRectangle(g,i*h,o,c,a,n,!0)}function RenderNRObjectBox(e,t,r){let l=e.pm,i=l.x,s=l.y,o=window.ThinkOfBBoxClass(e._class,e),c=window.bo_x[o],a=window.bo_y[o],n=window.bo_w[o],d=window.bo_h[o],g,w=w2s_y(s+a),h,u=w2s_h(d);-1!=l.side?(g=w2s_x(i+c),h=w2s_w(n)):(g=w2s_x(i-c),g+=h=w2s_w(-n),h=-h),_DrawRectangle(t,r,g,w,h,u,!0)}function RenderSingleNonResizableObject(e,t){let r=e._class,l=window.MatchLayer(e)?1:.3,i=e.pm,s=i.x,o=i.y,c="#000",a=.1;ObjIsHighlighted(e,t)&&(c=currentTheme.highLightedObjEdgeColor,a=currentTheme.highLightedObjEdgeOpacity/l),e.selected&&!toggles.originalSelectOverlay&&(c=currentTheme.selectOutlineColor,a=currentTheme.selectEdgeOpacityFactor),RenderNRObjectBox(e,c,l*a),ctx.globalAlpha=l;let n=!1;if("decor"==r){let d=i.model;void 0==window.special_values_table.decor_model[d]&&-1==decorRequestsOnProgress.indexOf(d)&&(window.ServerRequest(`a=get_images&for_class=decor_model&update_const=${d}`,"request_consts"),decorRequestsOnProgress.push(d)),(0!=i.r||1!=i.sx||1!=i.sy)&&(ctx.save(),ctx.translate(w2s_x(s),w2s_y(o)),ctx.rotate(i.r/180*Math.PI),ctx.scale(i.sx,i.sy),ctx.translate(-w2s_x(s),-w2s_y(o)),n=!0)}let g=window.ThinkOfOffsetClass(r,e),w=-1!=i.side?1:-1,h=w2s_x(s+w*window.lo_x[g]),u=w2s_y(o+window.lo_y[g]),x=w2s_w(w*window.lo_w[g]),m=w2s_h(window.lo_h[g]);if(-1==w&&(ctx.save(),ctx.translate(2*h+x,0),ctx.scale(-1,1)),-1!==["player","enemy"].indexOf(r))draw_image(window.img_chars_full[i.char],w2s_x(i.x-36),w2s_y(i.y-104),w2s_w(110),w2s_h(130));else if("decor"!=r||void 0===window.CACHED_DECORS[i.model]||window.CACHED_DECORS[i.model].native)draw_image(window.img_decide(e),h,u,x,m);else{-1!==decorRequestsOnProgress.indexOf(i.model)&&decorRequestsOnProgress.splice(decorRequestsOnProgress.indexOf(i.model),1);let $=window.CACHED_DECORS[i.model];draw_image($,w2s_x(i.x+i.u),w2s_y(i.y+i.v),w2s_w($.width),w2s_h($.height))}-1==w&&ctx.restore(),n&&ctx.restore()}function GetObjectCoordAndSize(e){let t=e.pm,r,l,i,s;if(e._isresizable)r=w2s_x(t.x),l=w2s_y(t.y),i=w2s_w(t.w),s=w2s_h(t.h);else{let o=window.ThinkOfBBoxClass(e._class,e);l=w2s_y(t.y+window.bo_y[o]),s=w2s_h(window.bo_h[o]),-1!=t.side?(r=w2s_x(t.x+window.bo_x[o]),i=w2s_w(window.bo_w[o])):(r=w2s_x(t.x-window.bo_x[o]),r+=i=w2s_w(-window.bo_w[o]),i=-i)}return{x:r,y:l,w:i,h:s}}function RenderObjectMarkAndName(e,t){if(!window.ENABLE_TEXT||void 0==e.pm.uid||!window.MatchLayer(e))return;void 0==window.last_title_density&&(window.last_title_density=0);let r=t.x+t.w/2,l=t.y+t.h/2,i=e.selected&&e.hit(!1);ctx.font="normal 10px Arial";let s=e.pm.uid,o=ctx.measureText(s);if(o.height=10,i&&(o.height=12),window.mouse_x>r-30&&window.mouse_x<r+30&&window.mouse_y>l-30&&window.mouse_y<l+30&&title_density++,ctx.globalAlpha=1,window.last_title_density>1&&!i){let c=Math.sqrt(Math.pow(window.mouse_x-r,2)+Math.pow(window.mouse_y-l,2));c<60&&(e.selected?ctx.globalAlpha=Math.max(.3,1/window.last_title_density):(r-=(window.mouse_x-r)*Math.pow((60-c)/60,2)*(4+Math.min(6,.1*window.last_title_density)),l-=(window.mouse_y-l)*Math.pow((60-c)/60,2)*(4+Math.min(6,.1*window.last_title_density)),window.last_title_density>1&&(ctx.globalAlpha=Math.max(.4,1-.1*window.last_title_density))))}let a=Math.round(r-o.width/2),n=Math.round(l-o.height/2);window.ENABLE_SHADOWS&&(ctx.fillStyle="rgba(0,0,0,0.1)",ctx.fillRect(a-2,n-2,o.width+4,o.height+4),ctx.fillRect(a-4,n-4,o.width+8,o.height+8)),ctx.fillStyle="#FFF",i&&(ctx.fillStyle="#fffb91"),e.selected&&(ctx.fillStyle=currentTheme.selectTextColor),ctx.fillText(s,a,n+8+(o.height-10)/2),window.last_title_density=window.title_density}function RenderSelectOverlay(e,t){e.selected&&toggles.originalSelectOverlay&&(ctx.globalAlpha=.2,ctx.fillStyle=window.selgrd2,draw_rect(t.x,t.y,t.w,t.h),ctx.globalAlpha=1,ctx.fillStyle="#FFF",window.MyDrawSelection(t.x-2,t.y-2,t.w+4,t.h+4))}function ChangeCursorIfHitsBorder(e,t){if(!e.selected||!e._isresizable||!window.MatchLayer(e))return;t.x,t.y,t.w,t.h;let r=e.pm.x,l=e.pm.y,i=e.pm.w,s=e.pm.h,o=mCurrentX,c=mCurrentY,a=window.borderwidth;if(o<r-a||r+i+a<o||c<l-a||l+s+a<c)return;let n,d,g,w=!1;r-a<=o&&o<=r+a&&(g=!0),r+i-a<=o&&o<=r+i+a&&(w=!0),l-a<=c&&c<=l+a&&(n=!0),l+s-a<=c&&c<=l+s+a&&(d=!0);let h="default";n&&g||d&&w?h="nwse-resize":n&&w||d&&g?h="nesw-resize":n||d?h="ns-resize":(g||w)&&(h="ew-resize"),window.canv.style.cursor!=h&&(window.canv.style.cursor=h)}function RenderQuickPick(e,t){if(!(window.quick_pick&&-1!=window.lqpc.indexOf(e._class))||!window.MatchLayer(e))return;let r=t.x,l=t.y,i=t.w,s=t.h,o=r+i/2,c=l+s/2,a=Math.sin(new Date().getTime()/100);ctx.globalAlpha=.75-a/4;let n=27+5*a,d=!1;window.Dist2D(o,c,window.mouse_x,window.mouse_y)<20*window.quick_pick_hit_scale&&(d=!0),draw_image(d?window.img_quickpick2:window.img_quickpick,o-n,c-n,2*n,2*n)}function RenderSingleObject(e){let t=GetObjectCoordAndSize(e);e._isresizable?RenderSingleResizableObject(e,t):RenderSingleNonResizableObject(e,t),RenderSelectOverlay(e,t),RenderQuickPick(e,t),RenderObjectMarkAndName(e,t),ChangeCursorIfHitsBorder(e,t)}function RenderAllObjects(){totalRenderedObjects=0;let e=window.left_panel.getBoundingClientRect(),t=window.right_panel.getBoundingClientRect(),r=window.top_panel.getBoundingClientRect(),l=Math.round(s2w_x(e.width+e.x)),i=Math.round(s2w_y(r.height+r.y)),s=Math.round(s2w_w(t.x-(e.width+e.x))),o=Math.round(s2w_h(canvasHeight-(r.height+r.y)));for(let c of window.es){let a=c.pm,n=a.x,d=a.y,g=a.w?a.w:0,w=a.h?a.h:0;!(n+g<l)&&!(d+w<i)&&!(l+s<n)&&!(i+o<d)&&c.exists&&c._isphysical&&(RenderSingleObject(c),totalRenderedObjects++)}}function RenderSelectionBox(){if(!window.m_drag_selection||window.lmd)return;let e=w2s_x(mClickX),t=w2s_y(mClickY),r=w2s_w(mCurrentX-mClickX),l=w2s_h(mCurrentY-mClickY),i=currentTheme.selectionColor;window.ctrl?i=currentTheme.selectionCtrlColor:window.alt&&(i=currentTheme.selectionAltColor),_DrawRectangle(i,currentTheme.selectionOpacity,e,t,r,l),_DrawRectangle(i,currentTheme.selectionEdgeOpacity,e,t,r,l,!0)}function RenderBackground(){window.SHOW_TEXTURES?draw_image(window.CACHED_SKY[previewBackground],0,0,canvasWidth,canvasHeight):(ctx.fillStyle=currentTheme.backgroundColor,draw_rect(0,0,canvasWidth,canvasHeight))}function SnapToGrid(e){return Math.round(e/window.GRID_SNAPPING)*window.GRID_SNAPPING}function RenderCrossCursor(){"edit"!=window.active_tool&&(ctx.globalAlpha=1,draw_image(window.img_put,w2s_x(SnapToGrid(mCurrentX))-15,w2s_y(SnapToGrid(mCurrentY))-15,31,31))}function RenderFrame(){window.need_redraw&&(canvasWidth=window.lsu,canvasHeight=window.lsv,currentTheme=themes[window.THEME],gridOpacity=window.GRID_ALPHA,mClickX=window.lmdrwa,mClickY=window.lmdrwb,mCurrentX=window.lmwa,mCurrentY=window.lmwb,window.canv.style.cursor="default",ctx.globalAlpha=1,RenderBackground(),RenderGrid(),RenderAllObjects(),RenderSelectionBox(),RenderCrossCursor())}function DisplayStatistics(){let e=document.getElementById("gui_renderInfo");void 0==e&&((e=document.createElement("div")).id="gui_renderInfo",e.innerHTML="Waiting for data...",window.right_panel.childNodes[0].insertBefore(e,document.getElementById("gui_params")));let t=" ";t+=`Renderer FPS: ${displayFPS} <br>`,t+=`Rendered Object: ${totalRenderedObjects} / ${window.es.length}`,e.innerHTML=t.slice(1).replaceAll("\n","<br>")}function getTimeMs(){return new Date().getTime()}function RequestRedrawIfGridMoved(){let e=window.k_shift?5:1,t=!1;if(0!==window.speed_x){let r=10*window.zoom*e*window.speed_x;window.dis_from_x+=r,window.dis_to_x+=r,t=!0}if(0!==window.speed_y){let l=10*window.zoom*e*window.speed_y;window.dis_from_y+=l,window.dis_to_y+=l,t=!0}t&&(window.zoom_validate(),window.need_redraw=!0,window.lmd=!1,window.lmwa=s2w_x(window.mouse_x),window.lmwb=s2w_x(window.mouse_y))}function HandleSingleFrame(){window.requestAnimationFrame(HandleSingleFrame),RequestRedrawIfGridMoved(),RenderFrame(),window.need_GUIParams_update&&(window.need_GUIParams_update=!1,window.UpdateGUIParams(),window.UpdateGUIObjectsList()),fpsAccumulator++,getTimeMs()-lastTime>=1e3&&(lastTime=getTimeMs(),displayFPS=fpsAccumulator,fpsAccumulator=0),DisplayStatistics(),aleiRunning&&!haveForcedRecalculation&&void 0!=document.getElementById("rparams")&&(window.ShowHideObjectBox(),window.ShowHideObjectBox(),haveForcedRecalculation=!0)}function PreviewModeUpdateVariables(e){if(e)for(let t of window.es){if("inf"!=t._class)continue;let r=t.pm;if("sky"==r.mark){previewBackground=r.forteam;return}}}function RegisterSettingsToALEI(){if(!window.ALEI_Active)return;aleiRunning=!0;let e=window.ALEIAPI.settings;e.addText("[R] Cartoonish Edges:",!1),e.createButtons("ALEI_Renderer_CartoonishEdges",toggles,"cartoonishEdges",[["Yes",!0],["No",!1]]),e.addText("[R] Original Select:",!1),e.createButtons("ALEI_Renderer_OriginalSelectOverlay",toggles,"originalSelectOverlay",[["Yes",!0],["No",!1]]),e.addText("[R] Preview walls:",!1),e.createButtons("ALEI_Renderer_PreviewWalls",toggles,"boxRendering",[["Yes",!0],["No",!1]]),window.ALEI_settingUpdateButtons()}!function(){ctx=window.ctx,draw_rect_edges=(e,t,r,l)=>ctx.strokeRect(e,t,r,l),draw_rect=window.lmfr,draw_gridlines=window.lg,draw_image=(e,t,r,l,i)=>window.MyDrawImage(e,t,r,l,i),w2s_x=window.w2s_x,w2s_y=window.w2s_y,s2w_x=window.s2w_x,s2w_y=window.s2w_y,w2s_h=window.w2s_h,w2s_w=window.w2s_w,s2w_h=window.s2w_h,s2w_w=window.s2w_w;let e=window.ShowTexturesSet;window.ShowTexturesSet=t=>{PreviewModeUpdateVariables(t),e(t)},window.Render=()=>{},window.ani=()=>{},window.requestAnimationFrame(HandleSingleFrame),lastTime=getTimeMs(),RegisterSettingsToALEI(),console.log("[ALEI Renderer]: Active.")}();
        return;
    };
